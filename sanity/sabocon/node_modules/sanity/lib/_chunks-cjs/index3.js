      ...
      operators.map((resolvedPanes) => {
        const routerPanes = resolvedPanes.reduce((acc, next) => {
          ...
          return {
            ...
            pane: pane2.type === "loading" ? StructureToolProvider.LOADING_PANE : pane2.paneNode,
...
function UnknownPane(props) {
  const { isSelected, pane: pane2, paneKey } = props, type = sanity.isRecord(pane2) && pane2.type || null, { t } = sanity.useTranslation(StructureToolProvider.structureLocaleNamespace);
...
function isDocumentPane(pane2) {
  return pane2 !== StructureToolProvider.LOADING_PANE && pane2.type === "document";
}
function isLoadingPane(pane2) {
  return pane2 === StructureToolProvider.LOADING_PANE;
}
const StyledPaneLayout = styledComponents.styled(StructureToolProvider.PaneLayout)`
  min-height: 100%;
  min-width: 320px;
        ...
        children: [
          paneDataItems.map(
            ({
              ...
              siblingIndex,
              selected
            }) => /* @__PURE__ */ jsxRuntime.jsx(React.Fragment, { children: pane2 === StructureToolProvider.LOADING_PANE ? /* @__PURE__ */ jsxRuntime.jsx(StructureToolProvider.LoadingPane, { paneKey, path, selected }) : /* @__PURE__ */ jsxRuntime.jsx(
              StructureToolPane,
              {
                active,
                groupIndex,
            ...
            ) }, `${pane2 === StructureToolProvider.LOADING_PANE ? "loading" : pane2.type}-${paneIndex}`)
          ),
...
var pane$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: StructureToolProvider.DocumentPane
}), pane = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: StructureToolProvider.PaneContainer
});
