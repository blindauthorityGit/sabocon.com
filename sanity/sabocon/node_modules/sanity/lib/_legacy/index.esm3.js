...
import { $ as usePaneLayout, a2 as ChildLink, _ as BackLink, a3 as ReferenceChildLink, a4 as ParameterizedLink, Q as useStructureTool, a5 as LOADING_PANE, O as structureLocaleNamespace, n as SerializeError, V as Pane, Y as PaneHeader, W as PaneContent, a6 as LoadingPane, P as PaneLayout, a8 as setActivePanes, S as StructureToolProvider, h as DocumentPane, a7 as PaneContainer } from "./StructureToolProvider.esm.js";
...
function UnknownPane(props) {
  const { isSelected, pane: pane2, paneKey } = props, type = isRecord(pane2) && pane2.type || null, { t } = useTranslation(structureLocaleNamespace);
        ...
        children: [
          paneDataItems.map(
            ({
              ...
              siblingIndex,
              selected
            }) => /* @__PURE__ */ jsx(Fragment, { children: pane2 === LOADING_PANE ? /* @__PURE__ */ jsx(LoadingPane, { paneKey, path, selected }) : /* @__PURE__ */ jsx(
              StructureToolPane,
              {
                active,
                groupIndex,
