...
`;function Te(e){const{mainDocumentState:t,onStructureParams:r,previewUrl:a,refs:c}=e,{t:d}=s.useTranslation(l.p),{devMode:p}=l.u(),f=o.useMemo((()=>c.filter((e=>{var n;return s.getPublishedId(e._id)!==(null==(n=null==t?void 0:t.document)?void 0:n._id)})).map((e=>e._id))),[t,c]),m=o.useMemo((()=>({id:"$root",options:{filter:"_id in $ids",params:{ids:f}},schemaTypeName:"",title:d("document-list-pane.document-list.title"),type:"documentList"})),[f,d]),[h,v]=o.useState(null),g=o.useCallback((()=>v(null)),[]),[x]=o.useState((()=>({})));return o.useEffect((()=>v(null)),[c]),h?n.jsx(we,{flex:1,message:d("document-list-pane.error.text"),onRetry:g,children:p&&n.jsx(i.Card,{overflow:"auto",padding:3,radius:2,tone:"critical",children:n.jsxs(i.Stack,{space:3,children:[n.jsx(i.Label,{muted:!0,size:0,children:d("presentation-error.label")}),n.jsx(Ie,{size:1,children:h.error.message})]})})}):n.jsx(i.ErrorBoundary,{onCatch:v,children:n.jsx(Ee,{children:n.jsx(u.StructureToolProvider,{children:n.jsx(Se,{onStructureParams:r,params:x,previewUrl:a,refs:c,children:n.jsx(Ce,{direction:"column",flex:1,children:n.jsx(u.DocumentListPane,{index:0,itemId:"$root",pane:m,paneKey:"$root"})})})})})})}const Re=c.styled(i.Code)`
  white-space: pre-wrap;
`;function Le(e){const{documentId:t,documentType:r,onFocusPath:c,onStructureParams:d,params:p,previewUrl:f}=e,{template:m,templateParams:h}=p,{t:v}=s.useTranslation(l.p),{devMode:g}=l.u(),x=o.useMemo((()=>({id:t,options:{id:t,type:r,template:m,templateParameters:a.decodeJsonParams(h)},title:"",type:"document"})),[t,r,m,h]),[y,b]=o.useState(null),w=o.useCallback((()=>b(null)),[]);return o.useEffect((()=>{b(null)}),[t,r,p]),y?n.jsx(we,{flex:1,message:v("document-pane.error.text"),onRetry:w,children:g&&n.jsx(i.Card,{overflow:"auto",padding:3,radius:2,tone:"critical",children:n.jsxs(i.Stack,{space:3,children:[n.jsx(i.Label,{muted:!0,size:0,children:v("presentation-error.label")}),n.jsx(Re,{size:1,children:y.error.message})]})})}):n.jsx(i.ErrorBoundary,{onCatch:b,children:n.jsx(u.PaneLayout,{style:{height:"100%"},children:n.jsx(Se,{onStructureParams:d,params:p,previewUrl:f,children:n.jsx(u.DocumentPane,{paneKey:"document",index:1,itemId:"document",pane:x,onFocusPath:c})})})})}function ze(e){const{documentId:t,documentType:r,onFocusPath:i,onStructureParams:o,previewUrl:s,structureParams:a}=e;return n.jsx(u.StructureToolProvider,{children:n.jsx(Le,{documentId:t,documentType:r,onFocusPath:i,onStructureParams:o,params:a,previewUrl:s})})}function De(e){const{documentId:t,documentType:r,mainDocumentState:c,onFocusPath:u,onStructureParams:p,previewUrl:f,refs:m,structureParams:h}=e,{t:v}=s.useTranslation(l.p),g=s.useSchema(),x=o.useCallback((e=>n.jsx(a.StateLink,{...e,state:{id:c.document._id,type:c.document._type,_searchParams:Object.entries({preview:f})}})),[c,f]);return t&&r?n.jsx(ze,{documentId:t,documentType:r,onFocusPath:u,onStructureParams:p,previewUrl:f,structureParams:h}):n.jsxs(i.Flex,{direction:"column",flex:1,height:"fill",children:[c&&n.jsx(i.Card,{padding:3,tone:c.document?"inherit":"caution",children:c.document?n.jsx(i.Card,{as:x,"data-as":"a",padding:0,radius:2,children:n.jsx(s.Preview,{schemaType:g.get(c.document._type),status:n.jsx(i.Badge,{children:v("main-document.label")}),value:c.document})}):n.jsx(i.Card,{padding:2,radius:2,tone:"inherit",children:n.jsxs(i.Flex,{gap:3,children:[n.jsx(i.Box,{flex:"none",children:n.jsx(i.Text,{size:1,children:n.jsx(d.WarningOutlineIcon,{})})}),n.jsx(i.Box,{flex:1,children:n.jsx(i.Text,{size:1,children:n.jsx(s.Translate,{t:v,i18nKey:"main-document.missing.text",components:{Code:"code"},values:{path:c.path}})})})]})})}),n.jsx(Te,{mainDocumentState:c,onStructureParams:p,previewUrl:f,refs:m})]})}const Me=c.styled.div`
  position: relative;
`,Oe=c.styled.div`
  position: absolute;
  top: 0;
